...
* **Energy carrier** (fossil fuel vs. electricity)
* **Conversion efficiency** (heat engines vs. electric motors)
* **Load factor** (passengers or cargo per vehicle)
* **Infrastructure** (roads vs. rails vs. airways)
...
1. **Mode matters more than distance**: A 1,000 km train journey can emit less than a 100 km car trip per passenger
2. **Electrification compounds advantages**: Electric systems are more efficient *and* become cleaner as grids decarbonize
3. **Energy density is a constraint, not destiny**: Batteries now serve most daily transport needs
4. **Infrastructure shapes choices**: Rail, tram, and bus networks enable low-carbon mobility at scale
5. **Travel behavior has ecological dimensions**: How we move affects not just climate, but ecosystems and communities

---

## Current Context (2025)

Global transportation emissions continue to rise, driven by expanding aviation and freight. However, electric vehicle adoption is accelerating, with EVs now representing over 20% of new car sales in major markets. The remaining 1.5°C carbon budget—approximately 170 GtCO2—makes rapid transport decarbonization essential.
